...
$route['attraction/(:any)']			= "attraction/index/$1";
$route['ajax/like_dislike_attraction'] = "attraction/like_dislike_attraction";
$route['ajax/submit_rating'] 		= "attraction/submit_rating";
...
$route['orders']					= "orders/order_details_list";
